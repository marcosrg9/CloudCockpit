import { primaryCommand, serverCommand } from 'src/app/interfaces/filter.interface'
import { server } from 'src/app/interfaces/server.interface'

export const settings = [

	{ name: 'settings_close_session', icon: 'logout', action: () => { } },
	{ name: 'settings_servers', icon: 'settings_gear', action: () => { } },

]

const a: any = {
	cmd__title__wol_server: '',
	asBase64: ''
}
